...
function MainScene:onCreate()
    ...
    local waitAnim = Flash:createMC("mojiaoxiaobinggou")
    -- local bujian1 = waitAnim:getChildByName("bujian1")
    -- local txt1 = bujian1:getChildByName("11__1")
    -- local txt2 = bujian1:getChildByName("11__2")
    -- txt1:setString("33333fffffffffffffffffffff")
    -- txt2:setString("11111111111111111111afffffff")
    waitAnim:addTo(self):move(0, -500)
